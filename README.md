...
I've spent four years building software — freelance web development since 2022, and since February 2024 at Skye8, where I moved from backend intern to leading the mobile team to building our backend services in NestJS.

That path means I've owned features end to end: database schema, API, mobile client, deployment. Most of what I build ships to users in Cameroon, where intermittent connectivity and low-end devices are the normal case rather than the edge case — which taught me that the interesting engineering usually lives in the failure paths, not the happy one.

I'm completing a **BTech in Data Science** at the University of Bamenda, conferred November 2026.

---

## Tech

Grouped by how much I've actually used them, rather than everything I've touched once.
...
MIT © 2026 Mufor Belmond Piannow
